...
values('admin','$2a$10$/RUbuT9KIqk6f8enaTQiLOXzhnUkiwEJRdtzdrMXXwU7dgnLKTCYG','Lê Minh Hiệu',1);
insert into user(username,password,fullname,status)
...
insert into new(title,category_id) values('Bài viết 1',1);
insert into new(title,category_id) values('Bài viết 2',1);
insert into new(title,category_id) values('Bài viết 3',2);
insert into new(title,category_id) values('Bài viết 4',1);
insert into new(title,category_id) values('Bài viết 5',1);
insert into new(title,category_id) values('Bài viết 6',2);